...
const ResolutionModal = ({ isOpen = true, onClose, incident, onSuccess, onResolved }) => {
  ...
  const handleSubmitResolution = async (e) => {
    ...
    try {
      ...
      // Update status to RESOLVED if needed
      await incidentApi.updateIncidentStatus(incident.id, {
        status: 'RESOLVED',
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#C8EAD9] font-medium">
                Incident #{incident.id.slice(0, 8).toUpperCase()} • {incident.category || 'Civic Issue'}
              </p>
            </div>
          </div>
